...
export const FamilyTreeParent = ({ name }: { name: string }) => {
    ...
    useEffect(() => {
        console.log('Fetching data for:', name) // Debugging log
        if (!name) return
    }, [name])
        ...
        const fetchFamilyTree = async () => {
            ...
            try {
                ...
                if (data.data.length > 0) {
                    ...
                    console.log(
                        'Updated state - MarriedTo:',
                        familyData?.descendants?.marriedTo
                    )
                    console.log(
                        'Updated state - Descendants:',
...
export const FamilyTreeChild = ({
    ...
    //                 setChildData((prev) => ({
    //                     ...prev,
    //                     [childName]: { marriedTo: [], descendants: [] },
    //                 }))
    //             }
    ...
    useEffect(() => {
        console.log('Received props - MarriedTo:', marriedTo)
        console.log('Received props - Descendants:', descendants)
    }, [marriedTo, descendants])
